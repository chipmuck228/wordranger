 ...
 * in-memory fixture for Ranger Trial, Word Bubble, Matching, Snake, and
 * Daily Training. `GAME_RUNTIME=memory` is a backward-compatible alias.
 * Production must leave both unset so student routes use durable Supabase
 * adapters.
 */
