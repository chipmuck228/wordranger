...
export const PlanningErrorCode = {
  ...
  PLAN_TARGET_REQUIREMENT_MISMATCH: "PLAN_TARGET_REQUIREMENT_MISMATCH",
  ...
  PLAN_MEMORY_ROUTING_UNRESOLVED: "PLAN_MEMORY_ROUTING_UNRESOLVED",
  PLAN_MEMORY_ROUTING_INTENT_MISMATCH: "PLAN_MEMORY_ROUTING_INTENT_MISMATCH",
} as const;
